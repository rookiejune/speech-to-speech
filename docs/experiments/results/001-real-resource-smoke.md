...
KV cache 与 source condition 契约后续由
[003 Cached Generation Contract](003-cached-generation-contract.md) 建立，并在
[004 Real Cached Generation](004-real-cached-generation.md) 中用真实资源复验；变长 batch
generation 的后续验收见
