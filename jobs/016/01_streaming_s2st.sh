...
job_reject_overrides experiment datamodule.source loader_plan trainer.max_epochs -- "$@"

cd "${SPEECH_TO_SPEECH_ROOT}"
echo "{\"event\":\"job.launch\",\"entry\":\"scripts/train.py\",\"experiment\":\"train/streaming_s2st\",\"assigned_devices\":\"${visible_devices}\"}"
