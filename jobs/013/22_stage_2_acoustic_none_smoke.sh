...
echo '{"event":"job.launch","experiment":"train/fdu_stage_2_acoustic_none_smoke","stage":"stage_2","objective":"token","entry":"train"}'
CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-0,1}" "${SPEECH_TO_SPEECH_PYTHON}" scripts/train.py \
  experiment=train/fdu_stage_2_acoustic_none_smoke \
