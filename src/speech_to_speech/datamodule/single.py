...
from .collate import TaskWeights
from .config import TaskConfig
from .loader.contract import ARFraming, validate_ar_framing
from .parse import from_frames, parse_audio_codes, raw_speech, speech_from_codes
from .contract import DataRuntime
from .sample import (
    RawSpeech,
    RawSpeechBatch,
    Speech,
...
def parse_single_sample(sample: types.Sample, runtime: DataRuntime) -> Speech:
    ...
    semantic_codes = parse_audio_codes(codes, runtime).semantic_codes
    if semantic_codes is None:
        raise ValueError("single-sample audio requires semantic codes.")
