...
class ConfigRuntimeContractTest(unittest.TestCase):
    ...
    def test_task_is_the_modality_source_of_truth(self):
        ...
        self.assertIsNone(Task.TTS_VOICE_CLONE.source_modality)
        self.assertIs(Task.TTS_VOICE_CLONE.target_modality, Modality.AUDIO)
        self.assertTrue(Task.TTS_VOICE_CLONE.uses_source_role)
